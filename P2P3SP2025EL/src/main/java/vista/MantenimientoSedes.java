...
public class MantenimientoSedes extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeCombos() {
        ...
        List<Sede> secciones = sedeDAO.select();
        cbox_empleado.addItem("Seleccione una opción");
        for (int i = 0; i < secciones.size(); i++) {
            cbox_empleado.addItem(secciones.get(i).getNombre_sede());
        }
    }
    ...
    public void llenadoDeTablas() {
        ...
        SedeDAO sedeDAO = new SedeDAO();
        List<Sede> sedes = sedeDAO.select(); //vendedores=alumnos, alumno=vendedor
    ...
    public void buscarVendedor() {
        ...
        txtEstatus.setText(sedeAConsultar.getEstatus_sede());
    }
...
//        // TODO add your handling code here:
        ...
        sedeAActualizar.setEstatus_sede(txtEstatus.getText());
